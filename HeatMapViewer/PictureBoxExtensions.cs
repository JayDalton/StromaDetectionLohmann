...
namespace Glaukopis.CognitionMasterPlugins {
	public static class PictureBoxExtensions {
		...
		public static Point TranslatePointToImageCoordinates(this PictureBox pictureBox,Point controlCoordinates) {
			switch(pictureBox.SizeMode) {
				...
				case PictureBoxSizeMode.Zoom:
					return translateZoomMousePosition(pictureBox,controlCoordinates);
			}
		...
		*/
		...
		/// </returns>
		private static Point translateZoomMousePosition(PictureBox pictureBox,Point coordinates) {
